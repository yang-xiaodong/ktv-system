<template>
  <div class="vip-container">
    <base-table :tableOptions="tableOptions" @edit="edit" @recharge="recharge"></base-table>
    <Modal v-model="modalFlag" title="充值" :footer-hide="true">
    ...
    <Modal v-model="recordFlag" :title="recordTitle" width="800" :footer-hide="true">
    ...
    return {
      tableOptions: {
        tableColumns: [
          ...
          {
            key: "recentConsumeTime",
            title: "最近消费时间",
            render: (h, params) => {
              return h(
                "span",
                params.row.recentConsumeTime
                  ? dateFormat(params.row.recentConsumeTime, "yyyy-MM-dd hh:mm")
                  : "暂无消费"
              );
            }
          },
          {
            key: "recentConsumeMoney",
            title: "最近消费金额",
            render: (h, params) => {
          ...
          },
          {
            ...
            render: (h, params) => {
              return h(
                "span",
                {},
                dateFormat(params.row.createTime, "yyyy-MM-dd hh:mm")
              );
            }
          }
        ],

<template>
  <div class="room-info">
    <base-table ref="baseTable" :tableOptions="tableOptions" @edit="edit"></base-table>
      ...
      tableOptions: {
        ...
        ruleValidate: {
          ...
          price: [
            ...
            {
              pattern: /^\d+(\.{0,1}\d{1,2}){0,1}$/,
              message: "必须为正数，最多两位小数",
              trigger: "blur"
            }
          ],
        ...
        this.$http
          ...
          .then(res => {
            if (res.data.code === 200) {
              ...
              this.tableOptions.formArray.splice(2, 1, {
                key: "unit",
                title: "单位",
                type: "select",
                options
          ...
          this.$http
            ...
            .then(res => {
              ...
              this.$set(
                this.params.row,
                "qty",
                this.params.row.qty - params.row.qty
              );
            });
        }
      });
